function() {
	...
	r.__moduleInfo = "当前为非稳定版本，如有Bug，请在酷安@StageGuard报告问题\n已实现：发送群组消息，构建消息链\n未实现：事件监听";
	Log.i("当前MiraiBot_HTTP.js版本： " + r.__version);
	...
	r.MessageTypeConst = {SOURCE:"Source", QUOTE: "Quote", AT: "At", ATALL: "AtAll", FACE: "Face", PLAIN: "Plain", IMAGE: "Image", XML: "Xml", JSON: "Json", APP: "App"};
	r.MessageType = {
		Source: (function(){
